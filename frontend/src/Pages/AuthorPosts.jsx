                    ...
                    <div className='flex flex-col items-center mb-4 pt-10 transition-all ease-in-out duration-500' key={post._id}>
                        <div className='relative'>
                            ...
                            {currentUser && currentUser.email === authorEmail && (
                                <div className={`absolute top-4 right-0 flex flex-col space-y-2 transition-all duration-500 ease-in-out ${showButtons ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
                                    <button 
                                        onClick={() => handleEditClick(post)}
                                        className="bg-blue-500 bg-opacity-70 text-white p-2 rounded-l-md text-xs flex h-5 items-center justify-center"
                                    >
                                        Modifica
                                    </button>
                                    <button 
                                        onClick={() => handleDeletePost(post._id)} 
                                        className="bg-red-500 bg-opacity-70 text-white p-2 rounded-l-md text-xs flex h-5 items-center justify-center"
                                    >
                                        Elimina
                                    </button>
                                </div>
